...
const Hero = ({
  title = "ליווי מקצועי ומסור בכל שלבי הלידה שלך",
  subtitle = "דולה מנוסה המעניקה תמיכה אישית, רגשית ופיזית בכל שלב בלידה עם רגישות, ידע ונוכחות מרגיעה לרגעים המשמעותיים ביותר",
